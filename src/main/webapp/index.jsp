...
<%
    // Fetch products from the database (will use the first 3 in the product section)
...
<head>
  ...
  <title>Furniture and Interior Design Websites by Er_Lalit</title>
</head>
  ...
  <div class="product-section">
    <div class="container">
      <div class="row">
        ...
        <!-- Static introduction column (unchanged) -->
        ...
        if (products != null && !products.isEmpty()) {
            ...
            for (product p : products) {
                if (count >= 3) break; // only show up to 3 products
                count++;
        %>
