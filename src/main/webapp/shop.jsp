...
<head>
    ...
    <link href="<%= request.getContextPath() %>/css/tiny-slider.css"
          rel="stylesheet">
...
<body>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="hero-img-wrap">
                        ...
                        <img src="<%= request.getContextPath() %>/images/couch.png"
                             class="img-fluid"
                             alt="Couch">
    ...
    <script src="<%= request.getContextPath() %>/js/tiny-slider.js">
    </script>
